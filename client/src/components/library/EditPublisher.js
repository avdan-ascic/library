...
import { readById, update } from "../../api/publisher-api";
    ...
    readById(params.id)
      .then((data) => {
        setValues({
          ...
          address: {
            road: data.publisher.address.road,
            zipCode: data.publisher.address.zipCode,
            city: data.publisher.address.city,
            country: data.publisher.address.country,
          },
        });
      })
